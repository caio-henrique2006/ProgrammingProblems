...
class Player(Sprite):
    ...
    def update(self, boxes):
        ...
        # gravity
        if self.vsp < 20 and not onground:  # 9.8 rounded up
            self.jump_animation()
        ...
        # movement
        self.move(self.speed, self.vsp, boxes)
...
def main():
    ...
    for bx in range(750, 1000, 70):
        boxes.add(Box(bx, 300))

    for bx in range(0, 1000, 70):
        boxes.add(Box(bx, 550))

    boxes.add(Box(650, 360))
